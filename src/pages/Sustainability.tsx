...
export default function Sustainability() {
  ...
  const environmentalPolicies = [
    ...
    },
    {
      ...
      descriptionAr: "منع التلوث الناتج عن الروائح أو تسرب المواد في أي مرحلة من مراحل النقل."
    }
  ];
  ...
  const arabicContent = `في إمداد، نعتبر الصحة والسلامة والأمن والبيئة والجودة (HSSEQ) أمورًا أساسية؛ هذه ليست مجرد سياسات، ولكنها رسالة نوايا والتزام، تضمن صحة وسلامة جميع الأشخاص المشاركين في عمليات النقل، وتقديم خدمات نقل عالية الجودة للعملاء، وتقليل الأثر البيئي في صميم عملياتنا.
