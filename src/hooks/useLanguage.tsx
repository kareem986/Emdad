...
const translations = {
  ...
  ar: {
    ...
    'quality.hero.subtitle': 'نحن لا نكتفي بأن نكون جيدين... بل نطمح أن نكون الأفضل. في "إمداد مباشر"، نُعيد تعريف معايير الجودة والكفاءة في قطاع النقل، ونسعى دومًا لتقديم تجربة متكاملة تُلبي تطلعاتك وتفوقها.',
